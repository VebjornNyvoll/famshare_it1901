...
import famshare.json.simple.parser.JSONParser;
import famshare.json.simple.parser.ParseException;
...
public class JSONValue {
	 ...
	 * 
	 * @see famshare.json.simple.parser.JSONParser#parse(Reader)
	 * @see #parseWithException(Reader)
	 * 
	 * @param in
	 * @return Instance of the following:
	 *	famshare.json.simple.JSONObject,
	 * 	famshare.json.simple.JSONArray,
	 * 	java.lang.String,
	 * 	java.lang.Number,
	 * 	java.lang.Boolean,
	 * 	null
	 ...
	 * Parse JSON text into java object from the input source.
	 * 
	 * @see famshare.json.simple.parser.JSONParser
	 * 
	 * @param in
	 * @return Instance of the following:
	 * 	famshare.json.simple.JSONObject,
     ...
     * 
     * @see famshare.json.simple.JSONObject#writeJSONString(Map, Writer)
     * @see famshare.json.simple.JSONArray#writeJSONString(List, Writer)
     * 
     * @param value
     * @param writer
     */
	 ...
	 * 
	 * @see famshare.json.simple.JSONObject#toJSONString(Map)
	 * @see famshare.json.simple.JSONArray#toJSONString(List)
	 * 
	 * @param value
